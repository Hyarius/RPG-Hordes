...
Vector2 g_board_size = Vector2(11, 11);

int main(int argc, char**argv)
{
	Vector2 board_size = Vector2(11, 11);
	Vector2 tile_size = Vector2(64, 64);

	Vector2 board_screen_size = board_size * tile_size + 60;
	...
	c_application win("State of Survie (c)", screen_size, Color(30, 30, 30));

	c_game_engine engine;
	engine.set_geometry(0, board_size * tile_size + 60);
	engine.activate();
